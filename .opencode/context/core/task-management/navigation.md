...
1. Load `standards/task-schema.md` (base structure reference)
2. Load `guides/splitting-tasks.md` (decomposition approach)
3. Reference planning agents: ArchitectureAnalyzer, StoryMapper, PrioritizationEngine, ContractManager, ADRManager
