...
|------|-------|----------|-----------|
| `agent-behavior.md` | **Critical behavioral rules** | ⭐⭐⭐⭐⭐ | **ALWAYS - Every interaction** |
...
**⚠️ ALWAYS load first**: `agent-behavior.md` (critical behavioral rules for every interaction)
