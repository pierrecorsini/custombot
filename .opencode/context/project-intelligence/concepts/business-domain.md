...
- `concepts/architecture.md` — How this business need is solved technically
- `concepts/business-tech-bridge.md` — Mapping between business and technical
- `lookup/decisions-log.md` — Business decisions with context
- `errors/known-issues.md` — Active issues and open questions
