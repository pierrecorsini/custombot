...
- `concepts/business-domain.md` — Business needs in detail
- `concepts/architecture.md` — Technical implementation in detail
- `lookup/decisions-log.md` — Decisions made with full context
- `errors/known-issues.md` — Current open questions and issues
