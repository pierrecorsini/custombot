<!-- Context: project-intelligence/lookup/project-structure | Priority: high | Version: 5.1 | Updated: 2026-05-07 -->
...
│   │
│   ├── constants/          # Named constants split by domain (14 modules)
...
│   │   └── ...
│   │
│   ├── core/               # Core engine (15 modules)
│   │   ├── context_assembler.py  # Memory + instructions + project context
│   │   ├── dedup.py         # Unified dedup (inbound + outbound + request) with buffered batch
...
│   │   └── ... (context_builder, errors, project_context, serialization, stream_accumulator, tool_formatter, topic_cache)
│   │
...
| `src/core/` | Engine: event bus, pipeline, orchestration | 15 modules |
