<!-- Context: core/navigation | Priority: critical | Version: 1.1 | Updated: 2026-05-04 -->
...
├── project-intelligence/   # Project intelligence & analysis
└── ui/                     # Visual design & UX
```
...
**project/** - Project context → `project/navigation.md`
**project-intelligence/** - Project analysis → `project-intelligence/navigation.md`
