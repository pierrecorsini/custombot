...
**Source**: `config.example.json`, `src/config/config.py`, `src/config/config_schema.py`
...
- `src/config/config_schema.py` — JSON Schema validation with field-level error messages
