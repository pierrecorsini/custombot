...
# Canonical set of transient LLM error codes that are worth retrying.
RETRYABLE_LLM_ERROR_CODES: frozenset[ErrorCode] = frozenset(
    {
...
def is_retryable(code: ErrorCode) -> bool:
    """Return True if *code* represents a transient, retryable LLM error."""
