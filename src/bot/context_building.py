    ...
    *,
    ...
    if not routing.has_rules:
        ...
        await _emit_event_safe(
            "message_dropped",
            {"chat_id": msg.chat_id, "sender_id": msg.sender_id, "reason": "no_rules"},
            "context_building.build_turn_context",
            get_correlation_id(),
        )
        return None
    ...
    if not matched_rule:
        ...
        await _emit_event_safe(
            "message_dropped",
            {"chat_id": msg.chat_id, "sender_id": msg.sender_id, "reason": "no_match"},
            "context_building.build_turn_context",
            get_correlation_id(),
        )
        return None
    ...
    with context_assembly_span(chat_id=msg.chat_id, rule_id=matched_rule.id) as span:
        ...
        add_span_event(
            span,
            "routing_matched",
            {"custombot.routing.rule_id": matched_rule.id},
        )
