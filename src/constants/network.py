...
# ─────────────────────────────────────────────────────────────────────────────
# Embedding HTTP Connection Pool
# ─────────────────────────────────────────────────────────────────────────────

# Maximum number of concurrent TCP connections for the dedicated embedding
# httpx client.  Embeddings are typically lightweight requests with small
# payloads — a smaller pool than the LLM client is sufficient.
DEFAULT_EMBEDDING_HTTPX_MAX_CONNECTIONS: int = 8

# Maximum idle keep-alive connections for the dedicated embedding client.
DEFAULT_EMBEDDING_HTTPX_MAX_KEEPALIVE_CONNECTIONS: int = 4
