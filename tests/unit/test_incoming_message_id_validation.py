...
class TestValidateMessageIdFunction:
    ...
    def test_valid_passes(self) -> None:
        _validate_message_id("3EB0123456789ABCDEF")

    def test_invalid_raises(self) -> None:
        with pytest.raises(ValueError, match="invalid characters"):
            _validate_message_id("../../etc")

    def test_custom_max_length(self) -> None:
        _validate_message_id("a" * 50)
        with pytest.raises(ValueError, match="exceeds maximum length"):
            _validate_message_id("a" * 50, max_length=10)
...
class TestValidateSenderIdFunction:
    ...
    def test_valid_passes(self) -> None:
        _validate_sender_id("1234567890")

    def test_invalid_raises(self) -> None:
        with pytest.raises(ValueError, match="invalid characters"):
            _validate_sender_id("../../etc")

    def test_custom_max_length(self) -> None:
        _validate_sender_id("a" * 50)
        with pytest.raises(ValueError, match="exceeds maximum length"):
            _validate_sender_id("a" * 50, max_length=10)
...
class TestMessageIdRegex:
    ...
    def test_allowed_characters(self, char: str) -> None:
        assert _MESSAGE_ID_RE.match(char), f"Character {char!r} should be allowed"
    ...
    def test_disallowed_characters(self, char: str) -> None:
        assert not _MESSAGE_ID_RE.match(char), f"Character {char!r} should be rejected"
...
class TestSenderIdRegex:
    ...
    def test_allowed_characters(self, char: str) -> None:
        assert _SENDER_ID_RE.match(char), f"Character {char!r} should be allowed"
    ...
    def test_disallowed_characters(self, char: str) -> None:
        assert not _SENDER_ID_RE.match(char), f"Character {char!r} should be rejected"
